pipeline {
    ...
    stages {
        ...
        stage('Test') {
            steps {
                dir ('lib') {
                    git branch: "master", credentialsId: "git-jacidm-key", url: "https://gitlab.code.dicelab.net/JAC-IDM/python-lib.git"
                }
                dir ('requests_lib') {
                    git branch: "master", credentialsId: "git-jacidm-key", url: "https://gitlab.code.dicelab.net/JAC-IDM/requests-lib.git"
                }
                sh """
                virtualenv test_env
