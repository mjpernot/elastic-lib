...
"""Program:  elasticsearchstatus_get_node_status.py
    ...
    Description:  Integration testing of get_node_status method in
...
class UnitTest(unittest.TestCase):
    ...
    def test_data(self):
        ...
        ess.connect()
        results = {"NodeStatus": {"TotalNodes": ess.total_nodes,
                                  "FailedNodes": ess.failed_nodes}}

        self.assertEqual(ess.get_node_status(), results)
