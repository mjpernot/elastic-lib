...
"""Program:  elasticsearchstatus_chk_status.py
    ...
    Description:  Integration testing of chk_status method in
...
class UnitTest(unittest.TestCase):
    ...
    def test_data(self):
        ...
        if ess.cluster_status != "green" or ess.pending_tasks > 0:
            self.assertTrue(ess.chk_status()["ClusterWarning"])

        else:
            self.assertFalse(ess.chk_status())
