...
"""Program:  elasticsearch_get_cluster_nodes.py

    Description:  Unit testing of get_cluster_nodes in
        elastic_class.ElasticSearch class.

    Usage:
        test/unit/elastic_class/elasticsearch_get_cluster_nodes.py
...
class UnitTest(unittest.TestCase):
    ...
    def test_default(self, mock_es):
        ...
        self.assertEqual(els.get_cluster_nodes(), self.results)
