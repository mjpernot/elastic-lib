...
"""Program:  elasticsearch_get_cluster_status.py

    Description:  Unit testing of get_cluster_status in
        elastic_class.ElasticSearch class.

    Usage:
        test/unit/elastic_class/elasticsearch_get_cluster_status.py
...
class UnitTest(unittest.TestCase):
    ...
    def test_default(self, mock_es):
        ...
        self.assertEqual(els.get_cluster_status(), self.results)
