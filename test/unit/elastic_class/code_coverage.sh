...
coverage run -a --source=elastic_class test/unit/elastic_class/elasticsearch_create_snapshot_repo.py
coverage run -a --source=elastic_class test/unit/elastic_class/elasticsearch_delete_snapshot.py
...
coverage run -a --source=elastic_class test/unit/elastic_class/elasticsearch_get_nodes2.py
...
coverage run -a --source=elastic_class test/unit/elastic_class/elasticsearch_get_dump_list.py
