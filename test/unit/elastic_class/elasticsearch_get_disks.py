...
"""Program:  elasticsearch_get_disks.py

    Description:  Unit testing of get_disks in elastic_class.ElasticSearch
        class.

    Usage:
        test/unit/elastic_class/elasticsearch_get_disks.py
