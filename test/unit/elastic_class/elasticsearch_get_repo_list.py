...
"""Program:  elasticsearch_get_repo_list.py

    Description:  Unit testing of get_repo_list in elastic_class.ElasticSearch
        class.

    Usage:
        test/unit/elastic_class/elasticsearch_get_repo_list.py
...
class UnitTest(unittest.TestCase):
    ...
    def test_default(self):
        ...
        self.assertEqual(els.get_repo_list(), self.results)
